...
which_subjects='new'
BIDS_dir=/scratch/groups/smackey/HEAL/BIDS
dwi_dir=/scratch/groups/smackey/HEAL/DWI_QA
...
do
  input_dir=/scratch/groups/smackey/HEAL/BIDS/${subject}/ses-01/dwi
  output_dir=/scratch/groups/smackey/HEAL/DWI_QA/${subject}

  export subject input_dir output_dir
  envsubst '${subject} ${input_dir} ${output_dir}' < HEAL_dwi_template.sbatch > scripts/HEAL_dwi_${subject}.sbatch
